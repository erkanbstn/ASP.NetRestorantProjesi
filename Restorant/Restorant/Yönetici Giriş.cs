...
namespace Restorant
{
    public partial class Yönetici_Giriş : Form
    {
        ...
        SqlDataReader dr;
        SqlDataReader dr2;
        private void Yönetici_Giriş_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            com.CommandText = "select * from Yonetici where Kullanıcı_Adı ='" + textBox1.Text + "'and Sifre ='" + textBox2.Text + "'";
